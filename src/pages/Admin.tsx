          ...
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold text-violet-700">1,234</div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between pb-2 border-b">
                    <div>
                      ...
                      <p className="text-sm text-gray-500">Business English Basics</p>
                    </div>
                  ...
                  <div className="flex items-center justify-between pb-2 border-b">
                    <div>
                      ...
                      <p className="text-sm text-gray-500">IELTS Speaking Practice Materials</p>
                    </div>
                  ...
                  <div className="flex items-center justify-between pb-2 border-b">
                    <div>
                      ...
                      <p className="text-sm text-gray-500">Server optimization</p>
                    </div>
                    <span className="text-sm text-gray-500">Yesterday</span>
                  </div>
                  ...
                  <div className="flex items-center justify-between pb-2 border-b">
                    <div>
                      ...
                      <p className="text-sm text-gray-500">Emily Johnson - Promoted to Administrator</p>
                    </div>
