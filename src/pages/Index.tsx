...
const Index = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#1A0B2E] to-[#2A1B3E]">
      <div className="text-center max-w-md p-6">
        ...
        <div className="space-y-4">
          <Button
            className="w-full text-white py-2 rounded-lg shadow-md border-0 bg-slate-950 hover:bg-slate-800"
            onClick={() => router("/public/home")}
          >
            Start Learning
          </Button>
          <Link to="/admin">
            <Button
              variant="outline"
              className="w-full border-[#8A6FF8] text-slate-50 bg-slate-950 hover:bg-slate-800"
            >
              Admin Dashboard
            </Button>
          </Link>
